...
public class SettingsMenu extends JFrame {
    ...
    private void easyButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_easyButtonActionPerformed
    ...
    private void volminusButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_volminusButtonActionPerformed
        if(settingsInstance.getVolume() > 0) {
            settingsInstance.setVolume(settingsInstance.getVolume() - 1);
            volumevalue.setText(Integer.toString(settingsInstance.getVolume()));
        }
    } //GEN-LAST:event_volminusButtonActionPerformed

    private void volplusButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_volplusButtonActionPerformed
        if(settingsInstance.getVolume() < 20) {
            settingsInstance.setVolume(settingsInstance.getVolume() + 1);
            volumevalue.setText(Integer.toString(settingsInstance.getVolume()));
        }
    } //GEN-LAST:event_volplusButtonActionPerformed
    
    private void hardButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_hardButtonActionPerformed
    ...
    private void soundButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_soundButtonActionPerformed
